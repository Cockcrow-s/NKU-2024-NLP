...
def _data_to_nparray(data, vocab, args):  ### revise here for bert
    '''
...
def load_dataset(args):
    ...
    # 创建词汇表
    counter = collections.Counter(_read_words(all_data))
    vocab = Vocab(counter, specials=['<pad>', '<unk>'], min_freq=5)
